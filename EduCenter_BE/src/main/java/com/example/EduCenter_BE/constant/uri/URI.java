...
public class URI {
    ...
    public final static String GET_ALL_STUDENTS_IN_CLASSROOM = "/get-all-students-in-classroom/{name}";
    ...
    public final static String UPDATE_ASSIGN_TEACHER = "/update-assign-teacher/{name}";
